"""Hudi architecture-and-roles 面试推演脚本。
...
@dataclass
class HudiArchitectureAndRolesChecklist:
    component: str = "Hudi"
...
if __name__ == "__main__":
    print(json.dumps(HudiArchitectureAndRolesChecklist().outline(), ensure_ascii=False, indent=2))
