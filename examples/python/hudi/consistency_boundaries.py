"""Hudi consistency-boundaries 面试推演脚本。
...
@dataclass
class HudiConsistencyBoundariesChecklist:
    component: str = "Hudi"
...
if __name__ == "__main__":
    print(json.dumps(HudiConsistencyBoundariesChecklist().outline(), ensure_ascii=False, indent=2))
