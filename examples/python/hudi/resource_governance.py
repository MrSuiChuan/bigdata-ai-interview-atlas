"""Hudi resource-governance 面试推演脚本。
...
@dataclass
class HudiResourceGovernanceChecklist:
    component: str = "Hudi"
...
if __name__ == "__main__":
    print(json.dumps(HudiResourceGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
