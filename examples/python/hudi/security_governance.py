"""Hudi security-governance 面试推演脚本。
...
@dataclass
class HudiSecurityGovernanceChecklist:
    component: str = "Hudi"
...
if __name__ == "__main__":
    print(json.dumps(HudiSecurityGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
