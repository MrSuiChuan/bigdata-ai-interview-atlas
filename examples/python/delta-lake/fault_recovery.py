"""Delta Lake fault-recovery 面试推演脚本。
...
@dataclass
class DeltaLakeFaultRecoveryChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeFaultRecoveryChecklist().outline(), ensure_ascii=False, indent=2))
