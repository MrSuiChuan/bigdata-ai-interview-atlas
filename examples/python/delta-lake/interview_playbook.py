"""Delta Lake interview-playbook 面试推演脚本。
...
@dataclass
class DeltaLakeInterviewPlaybookChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeInterviewPlaybookChecklist().outline(), ensure_ascii=False, indent=2))
