"""Delta Lake security-governance 面试推演脚本。
...
@dataclass
class DeltaLakeSecurityGovernanceChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeSecurityGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
