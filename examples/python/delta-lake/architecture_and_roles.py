"""Delta Lake architecture-and-roles 面试推演脚本。
...
@dataclass
class DeltaLakeArchitectureAndRolesChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeArchitectureAndRolesChecklist().outline(), ensure_ascii=False, indent=2))
