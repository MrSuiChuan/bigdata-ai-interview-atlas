"""Delta Lake maintenance-services 面试推演脚本。
...
@dataclass
class DeltaLakeMaintenanceServicesChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeMaintenanceServicesChecklist().outline(), ensure_ascii=False, indent=2))
