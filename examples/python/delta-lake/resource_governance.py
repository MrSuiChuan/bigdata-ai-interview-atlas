"""Delta Lake resource-governance 面试推演脚本。
...
@dataclass
class DeltaLakeResourceGovernanceChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeResourceGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
