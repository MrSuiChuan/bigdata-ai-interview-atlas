"""Delta Lake core-objects-state 面试推演脚本。
...
@dataclass
class DeltaLakeCoreObjectsStateChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeCoreObjectsStateChecklist().outline(), ensure_ascii=False, indent=2))
