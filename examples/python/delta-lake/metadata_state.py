"""Delta Lake metadata-state 面试推演脚本。
...
@dataclass
class DeltaLakeMetadataStateChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeMetadataStateChecklist().outline(), ensure_ascii=False, indent=2))
