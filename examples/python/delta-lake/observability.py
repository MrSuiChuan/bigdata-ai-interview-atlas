"""Delta Lake observability 面试推演脚本。
...
@dataclass
class DeltaLakeObservabilityChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeObservabilityChecklist().outline(), ensure_ascii=False, indent=2))
