"""Delta Lake consistency-boundaries 面试推演脚本。
...
@dataclass
class DeltaLakeConsistencyBoundariesChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeConsistencyBoundariesChecklist().outline(), ensure_ascii=False, indent=2))
