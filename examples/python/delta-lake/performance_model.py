"""Delta Lake performance-model 面试推演脚本。
...
@dataclass
class DeltaLakePerformanceModelChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakePerformanceModelChecklist().outline(), ensure_ascii=False, indent=2))
