"""Delta Lake system-design 面试推演脚本。
...
@dataclass
class DeltaLakeSystemDesignChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakeSystemDesignChecklist().outline(), ensure_ascii=False, indent=2))
