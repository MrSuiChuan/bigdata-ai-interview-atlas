"""Delta Lake partition-layout 面试推演脚本。
...
@dataclass
class DeltaLakePartitionLayoutChecklist:
...
if __name__ == "__main__":
    print(json.dumps(DeltaLakePartitionLayoutChecklist().outline(), ensure_ascii=False, indent=2))
