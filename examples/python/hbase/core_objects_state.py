"""HBase core-objects-state 面试推演脚本。
...
@dataclass
class HBaseCoreObjectsStateChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseCoreObjectsStateChecklist().outline(), ensure_ascii=False, indent=2))
