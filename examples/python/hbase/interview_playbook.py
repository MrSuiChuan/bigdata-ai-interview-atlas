"""HBase interview-playbook 面试推演脚本。
...
@dataclass
class HBaseInterviewPlaybookChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseInterviewPlaybookChecklist().outline(), ensure_ascii=False, indent=2))
