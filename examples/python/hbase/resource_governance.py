"""HBase resource-governance 面试推演脚本。
...
@dataclass
class HBaseResourceGovernanceChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseResourceGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
