"""HBase consistency-boundaries 面试推演脚本。
...
@dataclass
class HBaseConsistencyBoundariesChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseConsistencyBoundariesChecklist().outline(), ensure_ascii=False, indent=2))
