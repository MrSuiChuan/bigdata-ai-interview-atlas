"""HBase security-governance 面试推演脚本。
...
@dataclass
class HBaseSecurityGovernanceChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseSecurityGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
