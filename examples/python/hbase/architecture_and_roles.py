"""HBase architecture-and-roles 面试推演脚本。
...
@dataclass
class HBaseArchitectureAndRolesChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseArchitectureAndRolesChecklist().outline(), ensure_ascii=False, indent=2))
