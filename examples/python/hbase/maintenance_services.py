"""HBase maintenance-services 面试推演脚本。
...
@dataclass
class HBaseMaintenanceServicesChecklist:
    component: str = "HBase"
...
if __name__ == "__main__":
    print(json.dumps(HBaseMaintenanceServicesChecklist().outline(), ensure_ascii=False, indent=2))
