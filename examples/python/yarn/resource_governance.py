"""YARN resource-governance 面试推演脚本。
...
@dataclass
class YARNResourceGovernanceChecklist:
    component: str = "YARN"
...
if __name__ == "__main__":
    print(json.dumps(YARNResourceGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
