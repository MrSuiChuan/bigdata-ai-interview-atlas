"""YARN consistency-boundaries 面试推演脚本。
...
@dataclass
class YARNConsistencyBoundariesChecklist:
    component: str = "YARN"
...
if __name__ == "__main__":
    print(json.dumps(YARNConsistencyBoundariesChecklist().outline(), ensure_ascii=False, indent=2))
