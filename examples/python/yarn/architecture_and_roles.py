"""YARN architecture-and-roles 面试推演脚本。
...
@dataclass
class YARNArchitectureAndRolesChecklist:
    component: str = "YARN"
...
if __name__ == "__main__":
    print(json.dumps(YARNArchitectureAndRolesChecklist().outline(), ensure_ascii=False, indent=2))
