"""YARN maintenance-services 面试推演脚本。
...
@dataclass
class YARNMaintenanceServicesChecklist:
    component: str = "YARN"
...
if __name__ == "__main__":
    print(json.dumps(YARNMaintenanceServicesChecklist().outline(), ensure_ascii=False, indent=2))
