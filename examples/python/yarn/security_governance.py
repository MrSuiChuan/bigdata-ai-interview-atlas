"""YARN security-governance 面试推演脚本。
...
@dataclass
class YARNSecurityGovernanceChecklist:
    component: str = "YARN"
...
if __name__ == "__main__":
    print(json.dumps(YARNSecurityGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
