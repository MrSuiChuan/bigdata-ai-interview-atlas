"""Trino interview-playbook 面试推演脚本。
...
@dataclass
class TrinoInterviewPlaybookChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoInterviewPlaybookChecklist().outline(), ensure_ascii=False, indent=2))
