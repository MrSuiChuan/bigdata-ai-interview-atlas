"""Trino security-governance 面试推演脚本。
...
@dataclass
class TrinoSecurityGovernanceChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoSecurityGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
