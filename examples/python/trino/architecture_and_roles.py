"""Trino architecture-and-roles 面试推演脚本。
...
@dataclass
class TrinoArchitectureAndRolesChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoArchitectureAndRolesChecklist().outline(), ensure_ascii=False, indent=2))
