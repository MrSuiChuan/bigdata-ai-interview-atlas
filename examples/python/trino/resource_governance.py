"""Trino resource-governance 面试推演脚本。
...
@dataclass
class TrinoResourceGovernanceChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoResourceGovernanceChecklist().outline(), ensure_ascii=False, indent=2))
