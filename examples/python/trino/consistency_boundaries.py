"""Trino consistency-boundaries 面试推演脚本。
...
@dataclass
class TrinoConsistencyBoundariesChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoConsistencyBoundariesChecklist().outline(), ensure_ascii=False, indent=2))
