"""Trino core-objects-state 面试推演脚本。
...
@dataclass
class TrinoCoreObjectsStateChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoCoreObjectsStateChecklist().outline(), ensure_ascii=False, indent=2))
