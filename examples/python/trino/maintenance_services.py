"""Trino maintenance-services 面试推演脚本。
...
@dataclass
class TrinoMaintenanceServicesChecklist:
    component: str = "Trino"
...
if __name__ == "__main__":
    print(json.dumps(TrinoMaintenanceServicesChecklist().outline(), ensure_ascii=False, indent=2))
