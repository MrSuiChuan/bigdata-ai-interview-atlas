---
id: q-bigdata-clickhouse-0002
title: ClickHouse 的核心对象与状态面试题应该怎么讲到原理层？
domain: bigdata
...
claim_ids:
  ...
  - bigdata-clickhouse-claim-0003
related_docs:
  - bigdata/clickhouse/core-objects-state
estimated_minutes: 10
---

# 题目

ClickHouse 的核心对象与状态面试题应该怎么讲到原理层？
...
2. 核心对象：MergeTree、Part、Partition、Primary Key、Sorting Key、Granule、Mark、Sparse Index、Replica、Shard。
3. 写入形成新的 part，后台 merge 把小 part 合并成更大 part；查询时先做分区裁剪、主键/稀疏索引裁剪，再读取所需列。
4. 本主题重点是：把对象按状态所有权、交互关系和失败影响拆开。
