---
id: q-bigdata-clickhouse-0019
title: ClickHouse 的系统设计面试题应该怎么讲到原理层？
domain: bigdata
...
claim_ids:
  ...
  - bigdata-clickhouse-claim-0020
related_docs:
  - bigdata/clickhouse/system-design
estimated_minutes: 10
---

# 题目

ClickHouse 的系统设计面试题应该怎么讲到原理层？
...
3. 安全边界包括用户、角色、权限、网络、TLS、行列级策略和审计能力，不能只依赖应用层控制。
4. 副本、分片、Distributed 表和后台 merge 的问题要分开看；单副本表和复制表的恢复边界不同。
5. 本主题重点是：说明如何从需求、规模、可靠性、成本和运维设计完整方案。
