---
id: q-bigdata-clickhouse-0004
title: ClickHouse 的元数据与状态管理面试题应该怎么讲到原理层？
domain: bigdata
...
claim_ids:
  ...
  - bigdata-clickhouse-claim-0005
related_docs:
  - bigdata/clickhouse/metadata-state
estimated_minutes: 10
---

# 题目

ClickHouse 的元数据与状态管理面试题应该怎么讲到原理层？

# 一句话结论

MergeTree 表把数据组织成 parts，按分区和排序键写入，稀疏主键索引和 mark 帮助减少扫描，后台 merge 合并 parts。 这类题要从对象、状态、链路和边界回答，才能体现原理深度。
